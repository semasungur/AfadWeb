...
/// <summary>
/// Summary description for fotograflogo
/// </summary>
		public class fotograflogo
{
    ...
    protected static void KucukBoyut(System.Drawing.Image orjinalFoto, int boyut, string dosyaAdi)
    {
        ...
        islenmisFotograf = new System.Drawing.Bitmap(hedefGenislik, 50);
        ...
        grafik.DrawImage(orjinalFoto, paste_x, paste_y, new_width, 50);
        islenmisFotograf.Save(HttpContext.Current.Server.MapPath("../picture_library/" + "logo.png"), codec, eParams);
    }
}
