		...
		public class fotograf1920500
{
    ...
    protected static void KucukBoyut(System.Drawing.Image orjinalFoto, int boyut, string dosyaAdi)
    {
        ...
        islenmisFotograf = new System.Drawing.Bitmap(hedefGenislik, 500);
        ...
        grafik.DrawImage(orjinalFoto, paste_x, paste_y, new_width, 500);
        islenmisFotograf.Save(HttpContext.Current.Server.MapPath("../picture_library/" + dosyaAdi), codec, eParams);
    }
}
