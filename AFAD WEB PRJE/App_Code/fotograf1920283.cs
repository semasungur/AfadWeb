		...
		public class fotograf1920283
{
    ...
    protected static void KucukBoyut(System.Drawing.Image orjinalFoto, int boyut, string dosyaAdi)
    {
        ...
        islenmisFotograf = new System.Drawing.Bitmap(hedefGenislik, 283);
        ...
        grafik.DrawImage(orjinalFoto, paste_x, paste_y, new_width, 283);
        islenmisFotograf.Save(HttpContext.Current.Server.MapPath("../images/" + "page-title.jpg"), codec, eParams);
    }
}
